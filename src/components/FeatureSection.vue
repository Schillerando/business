<template>
  <section id="feature">
    <div class="container px-4 py-5" id="featured-3">
      <h2 class="pb-2 border-bottom">Das bietet Schillerando</h2>
    </div>
    <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
      <FeatureTile
        ...
        image="products.png"
        title="Angebote"
        text="Entdecke alle Angebote im Staat. Egal ob Essen, Trinken, Dienstleistung oder Aktivität."
        :link="mainUrl + '/angebote'"
        linkTitle="Angebote"
      ></FeatureTile>
      <FeatureTile
        :left="false"
        ...
        image="location.png"
        title="Unternehmen"
        text="Erhalte einen Überblick über alle Unternehmen im Staat und finde leichter zu ihnen."
        :link="mainUrl + '/unternehmen'"
        linkTitle="Unternehmen"
      ></FeatureTile>
      <FeatureTile
        :left="true"
        :forCompanies="false"
      ...
      <FeatureTile
        ...
        title="Lieferung"
        image="delivery.png"
        text="Lasse Produkte wie Essen oder Trinken schnell und kostenlos zu dir liefern."
        :link="mainUrl + '/auth'"
